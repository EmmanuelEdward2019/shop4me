...
// lucide-react doesn't ship a TikTok glyph, so we inline a minimal SVG
// that follows the same stroke/`currentColor` conventions as the other
// social icons.
...
const socialLinks = [
  { icon: Facebook, href: "https://web.facebook.com/Shop4Memarkets", label: "Facebook" },
  ...
  { icon: TikTok, href: "https://www.tiktok.com/@shop4memarkets", label: "TikTok" },
];
